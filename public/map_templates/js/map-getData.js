...
function createMapCard(mapMeta) {
    ...
    for (var i = 0; i < urls.length; i++) {
        ...
        card += '<div class="card__body" aria-hidden="true" style="display: none;">';
        ...
        card += '<div class="card__footer"><button class="btn-details btn btn-link btn-xs" type="button" aria-expanded="false"><span class="icon icon-caret-right"></span>View details</button></div>';
        card += '</li>';
